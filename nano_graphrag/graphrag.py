...
from ._llm import medgemma_complete, openai_embedding
from ._op import (
...
class GraphRAG:
    ...
    # LLM - Using local alibayram/medgemma:latest
    best_model_func: callable = medgemma_complete
    best_model_max_token_size: int = 8192
    best_model_max_async: int = 1
    cheap_model_func: callable = medgemma_complete
