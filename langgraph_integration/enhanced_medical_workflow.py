...
try:
    from .graphrag_node import AgentState, MedicalGraphRAGNode
...
class EnhancedMedicalSupervisorNode:
    ...
    def _create_enhanced_prompt(self, user_query: str, graphrag_context: str, 
        ...
        **Rationale:** [Clinical justification for this alternative option]
        **References:**
        1. [ACR source or enriched reference]  
        ...
        **Rationale:** [Clinical justification for this option]
        **References:**
        1. [ACR source or enriched reference]
        ...
        **CRITICAL REQUIREMENTS:**
        1. Show ALL available appropriate procedures (up to 3)
        ...
        6. If fewer than 3 procedures are available, show all available procedures using the same format
        """
        
        return prompt
    
    def _format_acr_summary(self, recommendations: Dict) -> str:
        """Format ACR recommendations summary"""
...
def create_enhanced_medical_workflow(llm, neo4j_password: str = None) -> StateGraph:
    ...
    # Initialize nodes
    graphrag_node = MedicalGraphRAGNode(neo4j_password=neo4j_password)
    acr_node = ACRRetrievalNode(neo4j_password=neo4j_password)
